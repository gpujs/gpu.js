...
*
* @version 2.16.0
* @date Sat, 28 Jan 2023 14:49:02 GMT
*
* @license MIT
* The MIT License
*
* Copyright (c) 2023 gpu.js Team
*/
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
  typeof define === 'function' && define.amd ? define(factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.GPU = factory());
  ...
  const utils = {
    ...
    getMinifySafeName: (fn) => {
      try {
        const ast = parse(`const value = ${fn.toString()}`);
...
highp float nrand(highp vec2 n) {
  ...
  const name$1 = 'math-random-uniformly-distributed';
  ...
  // language=GLSL
  const fragmentShader$1 = `__HEADER__;
...
void main(void) {
  ...
  // language=GLSL
  const vertexShader$1 = `__FLOAT_TACTIC_DECLARATION__;
__INT_TACTIC_DECLARATION__;
__SAMPLER_2D_TACTIC_DECLARATION__;
...
void main(void) {
  ...
  var glWiretapExports = {};
  var glWiretap = {
    get exports(){ return glWiretapExports; },
    set exports(v){ glWiretapExports = v; },
  };
...
${indent}})();`);
  ...
  function glKernelString(Kernel, args, originKernel, setupContextString, destroyContextString) {
    ...
    const postResult = [];
    const context = glWiretapExports.glWiretap(originKernel.context, {
...
${result.join('\n')}
  ...
  class WebGLKernel extends GLKernel {
    ...
    static setupFeatureChecks() {
      ...
      testContext$1 = testCanvas$1.getContext('webgl') || testCanvas$1.getContext('experimental-webgl');
      if (!testContext$1 || !testContext$1.getExtension) return;
      testExtensions = {
        OES_texture_float: testContext$1.getExtension('OES_texture_float'),
        OES_texture_float_linear: testContext$1.getExtension('OES_texture_float_linear'),
        OES_element_index_uint: testContext$1.getExtension('OES_element_index_uint'),
        WEBGL_draw_buffers: testContext$1.getExtension('WEBGL_draw_buffers'),
      };
    ...
    static getChannelCount() {
      return testExtensions.WEBGL_draw_buffers ?
        testContext$1.getParameter(testExtensions.WEBGL_draw_buffers.MAX_DRAW_BUFFERS_WEBGL) :
        1;
    }
...
void main(void) {
  ...
  class GPU {
    ...
    createKernel(source, settings) {
      ...
      if (this.mode === 'dev') {
        const devKernel = gpuMock_js.gpuMock(source, upgradeDeprecatedCreateKernelSettings(settings));
  ...
  GPU.webGLKernelValueMaps = kernelValueMaps$1;

  GPU.WebGL2FunctionNode = WebGL2FunctionNode;
  GPU.WebGL2Kernel = WebGL2Kernel;
  GPU.webGL2KernelValueMaps = kernelValueMaps;
