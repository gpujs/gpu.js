...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'single precision Array1D(2) auto',
  () => {
...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'single precision Array1D(2) gpu',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGLSupported ? test : skip)(
  'single precision Array1D(2) webgl',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGL2Supported ? test : skip)(
  'single precision Array1D(2) webgl2',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isHeadlessGLSupported ? test : skip)(
  'single precision Array1D(2) headlessgl',
  () => {
...
(GPU.isWebGLSupported ? test : skip)(
  'fallback unsigned precision Array1D(2) webgl',
  () => {
...
(GPU.isWebGL2Supported ? test : skip)(
  'fallback unsigned precision Array1D(2) webgl2',
  () => {
...
(GPU.isHeadlessGLSupported ? test : skip)(
  'fallback unsigned precision Array1D(2) headlessgl',
  () => {
...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'single precision Array1D(3) auto',
  () => {
...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'single precision Array1D(3) gpu',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGLSupported ? test : skip)(
  'single precision Array1D(3) webgl',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGL2Supported ? test : skip)(
  'single precision Array1D(3) webgl2',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isHeadlessGLSupported ? test : skip)(
  'single precision Array1D(3) headlessgl',
  () => {
...
(GPU.isWebGLSupported ? test : skip)(
  'fallback unsigned precision Array1D(3) webgl',
  () => {
...
(GPU.isWebGL2Supported ? test : skip)(
  'fallback unsigned precision Array1D(3) webgl2',
  () => {
...
(GPU.isHeadlessGLSupported ? test : skip)(
  'fallback unsigned precision Array1D(3) headlessgl',
  () => {
...
(GPU.isWebGLSupported ? test : skip)(
  'fallback unsigned precision Array1D(4) webgl',
  () => {
...
(GPU.isWebGL2Supported ? test : skip)(
  'fallback unsigned precision Array1D(4) webgl2',
  () => {
...
(GPU.isHeadlessGLSupported ? test : skip)(
  'fallback unsigned precision Array1D(4) headlessgl',
  () => {
