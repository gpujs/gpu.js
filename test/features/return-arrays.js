...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'return Array(2) from kernel auto',
  () => {
...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'return Array(2) from kernel gpu',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGLSupported ? test : skip)(
  'return Array(2) from kernel webgl',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGL2Supported ? test : skip)(
  'return Array(2) from kernel webgl2',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isHeadlessGLSupported ? test : skip)(
  'return Array(2) from kernel headlessgl',
  () => {
...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'return Array2D(2) from kernel auto',
  () => {
...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'return Array2D(2) from kernel gpu',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGLSupported ? test : skip)(
  'return Array2D(2) from kernel webgl',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGL2Supported ? test : skip)(
  'return Array2D(2) from kernel webgl2',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isHeadlessGLSupported ? test : skip)(
  'return Array2D(2) from kernel headlessgl',
  () => {
...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'return Array3D(2) from kernel auto',
  () => {
...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'return Array3D(2) from kernel gpu',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGLSupported ? test : skip)(
  'return Array3D(2) from kernel webgl',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGL2Supported ? test : skip)(
  'return Array3D(2) from kernel webgl2',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isHeadlessGLSupported ? test : skip)(
  'return Array3D(2) from kernel headlessgl',
  () => {
...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'return Array(3) from kernel auto',
  () => {
...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'return Array(3) from kernel gpu',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGLSupported ? test : skip)(
  'return Array(3) from kernel webgl',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGL2Supported ? test : skip)(
  'return Array(3) from kernel webgl2',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isHeadlessGLSupported ? test : skip)(
  'return Array(3) from kernel headlessgl',
  () => {
...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'return Array2D(3) from kernel auto',
  () => {
...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'return Array2D(3) from kernel gpu',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGLSupported ? test : skip)(
  'return Array2D(3) from kernel webgl',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGL2Supported ? test : skip)(
  'return Array2D(3) from kernel webgl2',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isHeadlessGLSupported ? test : skip)(
  'return Array2D(3) from kernel headlessgl',
  () => {
...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'return Array3D(3) from kernel auto',
  () => {
...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'return Array3D(3) from kernel gpu',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGLSupported ? test : skip)(
  'return Array3D(3) from kernel webgl',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGL2Supported ? test : skip)(
  'return Array3D(3) from kernel webgl2',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isHeadlessGLSupported ? test : skip)(
  'return Array3D(3) from kernel headlessgl',
  () => {
...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'return Array(4) from kernel auto',
  () => {
...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'return Array(4) from kernel gpu',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGLSupported ? test : skip)(
  'return Array(4) from kernel webgl',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGL2Supported ? test : skip)(
  'return Array(4) from kernel webgl2',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isHeadlessGLSupported ? test : skip)(
  'return Array(4) from kernel headlessgl',
  () => {
...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'return Array2D(4) from kernel auto',
  () => {
...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'return Array2D(4) from kernel gpu',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGLSupported ? test : skip)(
  'return Array2D(4) from kernel webgl',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGL2Supported ? test : skip)(
  'return Array2D(4) from kernel webgl2',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isHeadlessGLSupported ? test : skip)(
  'return Array2D(4) from kernel headlessgl',
  () => {
...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'return Array3D(4) from kernel auto',
  () => {
...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'return Array3D(4) from kernel gpu',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGLSupported ? test : skip)(
  'return Array3D(4) from kernel webgl',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGL2Supported ? test : skip)(
  'return Array3D(4) from kernel webgl2',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isHeadlessGLSupported ? test : skip)(
  'return Array3D(4) from kernel headlessgl',
  () => {
...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'return Array(2) from kernel variables 33 in length auto',
  () => {
    returnArray2FromKernelVariables33Length();
  }
);

(GPU.isSinglePrecisionSupported && GPU.isGPUSupported ? test : skip)(
  'return Array(2) from kernel variables 33 in length gpu',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGLSupported ? test : skip)(
  'return Array(2) from kernel variables 33 in length webgl',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGL2Supported ? test : skip)(
  'return Array(2) from kernel variables 33 in length webgl2',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isHeadlessGLSupported ? test : skip)(
  'return Array(2) from kernel variables 33 in length headlessgl',
  () => {
...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'return Array(3) from kernel variables 33 in length auto',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isGPUSupported ? test : skip)(
  'return Array(3) from kernel variables 33 in length gpu',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGLSupported ? test : skip)(
  'return Array(3) from kernel variables 33 in length webgl',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGL2Supported ? test : skip)(
  'return Array(3) from kernel variables 33 in length webgl2',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isHeadlessGLSupported ? test : skip)(
  'return Array(3) from kernel variables 33 in length headlessgl',
  () => {
...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'return Array(4) from kernel variables 33 in length auto',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isGPUSupported ? test : skip)(
  'return Array(4) from kernel variables 33 in length gpu',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGLSupported ? test : skip)(
  'return Array(4) from kernel variables 33 in length webgl',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGL2Supported ? test : skip)(
  'return Array(4) from kernel variables 33 in length webgl2',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isHeadlessGLSupported ? test : skip)(
  'return Array(4) from kernel variables 33 in length headlessgl',
  () => {
