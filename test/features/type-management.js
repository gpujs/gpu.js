...
test('arrays arguments - Array(2) webgl', () => {
  const node = new WebGLFunctionNode(
    function arrayArguments(array, array2) {
      const array3 = [0, 0];
      array3[0] = array[0];
      array3[1] = array[1] * array2[1];
      return array3;
    }.toString(),
    { argumentTypes: ['Array(2)', 'Array(2)'], output: [1] }
  );
  assert.equal(
    node.toString(),
    'vec2 arrayArguments(vec2 user_array, vec2 user_array2) {\n\
...
test('arrays arguments - Array(2) cpu', () => {
  ...
  assert.equal(
    node.toString(),
    'function arrayArguments(user_array, user_array2) {\n\
...
test('arrays arguments - Array(3) webgl', () => {
  const node = new WebGLFunctionNode(
    ...
    { argumentTypes: ['Array(3)', 'Array(3)'], output: [1] }
  );
  assert.equal(
    node.toString(),
    'vec3 arrayArguments(vec3 user_array, vec3 user_array2) {\n\
...
test('arrays arguments - Array(4) webgl', () => {
  const node = new WebGLFunctionNode(
    ...
    { argumentTypes: ['Array(4)', 'Array(4)'], output: [1] }
  );
  assert.equal(
    node.toString(),
    'vec4 arrayArguments(vec4 user_array, vec4 user_array2) {\n\
...
test('arrays inherited - Array(2) webgl', () => {
  const node = new WebGLFunctionNode(
    function inherited(array, array2) {
      const array3 = [0, 0];
      array3[0] = array[0];
      array3[1] = array[1] * array2[1];
      return array3;
  ...
  assert.equal(
    node.toString(),
    'vec2 inherited(vec2 user_array, vec2 user_array2) {\n\
vec2 user_array3=vec2(0.0, 0.0);\n\
user_array3[0]=user_array[0];\n\
user_array3[1]=(user_array[1]*user_array2[1]);\n\
return user_array3;\n\
...
test('arrays inherited - Array(2) cpu', () => {
  ...
  assert.equal(
    node.toString(),
    'function inherited(user_array, user_array2) {\n\
const user_array3=new Float32Array([0, 0]);\n\
user_array3[0]=user_array[0];\n\
user_array3[1]=(user_array[1]*user_array2[1]);\n\
return user_array3;\n\
...
test('arrays inherited - Array(3) webgl', () => {
  ...
  assert.equal(
    node.toString(),
    'vec3 inherited(vec3 user_array, vec3 user_array2) {\n\
vec3 user_array3=vec3(0.0, 0.0, 0.0);\n\
user_array3[0]=user_array[0];\n\
user_array3[1]=(user_array[1]*user_array2[1]);\n\
return user_array3;\n\
...
test('auto detect float, array, array2d, array3d - webgl', () => {
  const node = new WebGLFunctionNode(
    `function advancedUsed(int, array, array2d, array3d) {
