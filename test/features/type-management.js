...
return vec2(0.0, 0.0);\n\
  ...
  QUnit.test('type management - arrays directly - Array(2) headlessgl', function(assert) {
    var node = new GPU.HeadlessGLFunctionNode(null, function direct() {
      return [0, 0];
    }, { returnType: 'Array(2)' });
    assert.equal(node.generate(), 'vec2 direct() {\n\
return vec2(0.0, 0.0);\n\
...
return vec3(0.0, 0.0, 0.0);\n\
  ...
  QUnit.test('type management - arrays directly - Array(3) headlessgl', function(assert) {
    var node = new GPU.HeadlessGLFunctionNode(null, function direct() {
      return [0, 0, 0];
    }, { returnType: 'Array(3)' });
    assert.equal(node.generate(), 'vec3 direct() {\n\
...
return vec4(0.0, 0.0, 0.0, 0.0);\n\
  ...
  QUnit.test('type management - arrays directly - Array(4) headlessgl', function(assert) {
    var node = new GPU.HeadlessGLFunctionNode(null, function direct() {
      return [0, 0, 0, 0];
    }, { returnType: 'Array(4)' });
    assert.equal(node.generate(), 'vec4 direct() {\n\
...
return user_array;\n\
  ...
  QUnit.test('type management - arrays referenced directly - Array(2) headlessgl', function(assert) {
    var node = new GPU.HeadlessGLFunctionNode(null, function refDirect() {
      const array = [0, 0];
      return array;
    }, { returnType: 'Array(2)' });
    assert.equal(node.generate(), 'vec2 refDirect() {\n\
...
return user_array;\n\
  ...
  QUnit.test('type management - arrays referenced directly - Array(3) headlessgl', function(assert) {
    var node = new GPU.HeadlessGLFunctionNode(null, function refDirect() {
      const array = [0, 0, 0];
      return array;
    }, { returnType: 'Array(3)' });
...
return user_array;\n\
  ...
  QUnit.test('type management - arrays referenced directly - Array(4) headlessgl', function(assert) {
    var node = new GPU.HeadlessGLFunctionNode(null, function refDirect() {
      const array = [0, 0, 0, 0];
      return array;
    }, { returnType: 'Array(4)' });
...
return user_array2;\n\
  ...
  QUnit.test('type management - arrays referenced indirectly - Array(2) headlessgl', function(assert) {
    var node = new GPU.HeadlessGLFunctionNode(null, function indirect() {
      const array = [0, 0];
      const array2 = array;
      return array2;
    }, { returnType: 'Array(2)' });
...
return user_array2;\n\
  ...
  QUnit.test('type management - arrays referenced indirectly - Array(3) headlessgl', function(assert) {
    var node = new GPU.HeadlessGLFunctionNode(null, function indirect() {
      const array = [0, 0, 0];
      const array2 = array;
      return array2;
...
return user_array2;\n\
  ...
  QUnit.test('type management - arrays referenced indirectly - Array(4) headlessgl', function(assert) {
    var node = new GPU.HeadlessGLFunctionNode(null, function indirect() {
      const array = [0, 0, 0, 0];
      const array2 = array;
      return array2;
...
return user_array3;\n\
  ...
  QUnit.test('type management - arrays arguments - Array(2) headlessgl', function(assert) {
    var node = new GPU.HeadlessGLFunctionNode(null, function arrayArguments(array, array2) {
      const array3 = [0, 0];
      array3[0] = array[0];
      array3[1] = array[1] * array2[1];
      return array3;
...
return user_array3;\n\
  ...
  QUnit.test('type management - arrays arguments - Array(3) headlessgl', function(assert) {
    var node = new GPU.HeadlessGLFunctionNode(null, function arrayArguments(array, array2) {
      const array3 = [0, 0];
      array3[0] = array[0];
      array3[1] = array[1] * array2[1];
...
return user_array3;\n\
  ...
  QUnit.test('type management - arrays arguments - Array(4) headlessgl', function(assert) {
    var node = new GPU.HeadlessGLFunctionNode(null, function arrayArguments(array, array2) {
      const array3 = [0, 0];
      array3[0] = array[0];
      array3[1] = array[1] * array2[1];
...
return user_array3;\n\
  ...
  QUnit.test('type management - arrays inherited - Array(2) headlessgl', function(assert) {
    var node = new GPU.HeadlessGLFunctionNode(null, function inherited(array, array2) {
      const array3 = [0, 0];
      array3[0] = array[0];
      array3[1] = array[1] * array2[1];
      return array3;
...
return user_array3;\n\
  ...
  QUnit.test('type management - arrays inherited - Array(3) headlessgl', function(assert) {
    var node = new GPU.HeadlessGLFunctionNode(null, function inherited(array, array2) {
      const array3 = [0, 0, 0];
      array3[0] = array[0];
      array3[1] = array[1] * array2[1];
...
return user_array3;\n\
  ...
  QUnit.test('type management - arrays inherited - Array(4) headlessgl', function(assert) {
    var node = new GPU.HeadlessGLFunctionNode(null, function inherited(array, array2) {
      const array3 = [0, 0, 0, 0];
      array3[0] = array[0];
      array3[1] = array[1] * array2[1];
