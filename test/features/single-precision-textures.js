...
(GPU.isSinglePrecisionSupported &&
  GPU.isWebGLSupported &&
  GPU.isKernelMapSupported
  ? test
  : skip)('with Array webgl', () => {
...
(GPU.isSinglePrecisionSupported &&
  GPU.isHeadlessGLSupported &&
  GPU.isKernelMapSupported
  ? test
  : skip)('with Array headlessgl', () => {
...
(GPU.isSinglePrecisionSupported &&
  ...
  GPU.isKernelMapSupported
  ? test
  : skip)('with Float32Array webgl', () => {
  singlePrecisionTexturesWithFloat32Array('webgl');
});

(GPU.isSinglePrecisionSupported && GPU.isWebGL2Supported ? test : skip)(
  'with Float32Array webgl2',
  () => {
...
(GPU.isSinglePrecisionSupported &&
  ...
  GPU.isKernelMapSupported
  ? test
  : skip)('with Float32Array headlessgl', () => {
...
(GPU.isSinglePrecisionSupported &&
  ...
  GPU.isKernelMapSupported
  ? test
  : skip)('with Uint16Array webgl', () => {
  singlePrecisionTexturesWithUint16Array('webgl');
});

(GPU.isSinglePrecisionSupported && GPU.isWebGL2Supported ? test : skip)(
  'with Uint16Array webgl2',
  () => {
...
(GPU.isSinglePrecisionSupported &&
  ...
  GPU.isKernelMapSupported
  ? test
  : skip)('with Uint16Array headlessgl', () => {
...
(GPU.isSinglePrecisionSupported &&
  ...
  GPU.isKernelMapSupported
  ? test
  : skip)('with Uint8Array webgl', () => {
  singlePrecisionTexturesWithUint8Array('webgl');
});

(GPU.isSinglePrecisionSupported && GPU.isWebGL2Supported ? test : skip)(
  'with Uint8Array webgl2',
  () => {
...
(GPU.isSinglePrecisionSupported &&
  ...
  GPU.isKernelMapSupported
  ? test
  : skip)('with Uint8ClampedArray webgl', () => {
  singlePrecisionTexturesWithUint8ClampedArray('webgl');
});

(GPU.isSinglePrecisionSupported && GPU.isWebGL2Supported ? test : skip)(
  'with Uint8ClampedArray webgl2',
  () => {
...
(GPU.isSinglePrecisionSupported &&
  ...
  GPU.isKernelMapSupported
  ? test
  : skip)('with Float32Array2D webgl', () => {
  singlePrecisionTexturesWithFloat32Array2D('webgl');
});

(GPU.isSinglePrecisionSupported && GPU.isWebGL2Supported ? test : skip)(
  'with Float32Array2D webgl2',
  () => {
...
(GPU.isSinglePrecisionSupported &&
  ...
  GPU.isKernelMapSupported
  ? test
  : skip)('with Uint16Array2D webgl', () => {
  singlePrecisionTexturesWithUint16Array2D('webgl');
});

(GPU.isSinglePrecisionSupported && GPU.isWebGL2Supported ? test : skip)(
  'with Uint16Array2D webgl2',
  () => {
...
(GPU.isSinglePrecisionSupported &&
  ...
  GPU.isKernelMapSupported
  ? test
  : skip)('with Uint16Array2D headlessgl', () => {
...
(GPU.isSinglePrecisionSupported &&
  ...
  GPU.isKernelMapSupported
  ? test
  : skip)('with Uint8Array2D webgl', () => {
  singlePrecisionTexturesWithUint8Array2D('webgl');
});

(GPU.isSinglePrecisionSupported && GPU.isWebGL2Supported ? test : skip)(
  'with Uint8Array2D webgl2',
  () => {
...
(GPU.isSinglePrecisionSupported &&
  ...
  GPU.isKernelMapSupported
  ? test
  : skip)('with Uint8Array2D headlessgl', () => {
...
(GPU.isSinglePrecisionSupported &&
  ...
  GPU.isKernelMapSupported
  ? test
  : skip)('with Uint8ClampedArray2D webgl', () => {
  singlePrecisionTexturesWithUint8ClampedArray2D('webgl');
});

(GPU.isSinglePrecisionSupported && GPU.isWebGL2Supported ? test : skip)(
  'with Uint8ClampedArray2D webgl2',
  () => {
...
(GPU.isSinglePrecisionSupported &&
  ...
  GPU.isKernelMapSupported
  ? test
  : skip)('with Uint8ClampedArray2D headlessgl', () => {
...
(GPU.isSinglePrecisionSupported &&
  ...
  GPU.isKernelMapSupported
  ? test
  : skip)('with Float32Array3D webgl', () => {
  singlePrecisionTexturesWithFloat32Array3D('webgl');
});

(GPU.isSinglePrecisionSupported && GPU.isWebGL2Supported ? test : skip)(
  'with Float32Array3D webgl2',
  () => {
...
(GPU.isSinglePrecisionSupported &&
  ...
  GPU.isKernelMapSupported
  ? test
  : skip)('with Float32Array3D headlessgl', () => {
...
(GPU.isSinglePrecisionSupported &&
  ...
  GPU.isKernelMapSupported
  ? test
  : skip)('with Uint16Array3D webgl', () => {
  singlePrecisionTexturesWithUint16Array3D('webgl');
});

(GPU.isSinglePrecisionSupported && GPU.isWebGL2Supported ? test : skip)(
  'with Uint16Array3D webgl2',
  () => {
...
(GPU.isSinglePrecisionSupported &&
  ...
  GPU.isKernelMapSupported
  ? test
  : skip)('with Uint16Array3D headlessgl', () => {
...
(GPU.isSinglePrecisionSupported &&
  ...
  GPU.isKernelMapSupported
  ? test
  : skip)('with Uint8Array3D webgl', () => {
  singlePrecisionTexturesWithUint8Array3D('webgl');
});

(GPU.isSinglePrecisionSupported && GPU.isWebGL2Supported ? test : skip)(
  'with Uint8Array3D webgl2',
  () => {
...
(GPU.isSinglePrecisionSupported &&
  ...
  GPU.isKernelMapSupported
  ? test
  : skip)('with Uint8Array3D headlessgl', () => {
...
(GPU.isSinglePrecisionSupported &&
  ...
  GPU.isKernelMapSupported
  ? test
  : skip)('with Uint8ClampedArray3D webgl', () => {
  singlePrecisionTexturesWithUint8ClampedArray3D('webgl');
});

(GPU.isSinglePrecisionSupported && GPU.isWebGL2Supported ? test : skip)(
  'with Uint8ClampedArray3D webgl2',
  () => {
...
(GPU.isSinglePrecisionSupported &&
  ...
  GPU.isKernelMapSupported
  ? test
  : skip)('with Uint8ClampedArray3D headlessgl', () => {
...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'immutable does not collide with kernel texture auto',
  () => {
...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'immutable does not collide with kernel texture gpu',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGLSupported ? test : skip)(
  'immutable does not collide with kernel texture webgl',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGL2Supported ? test : skip)(
  'immutable does not collide with kernel texture webgl2',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isHeadlessGLSupported ? test : skip)(
  'immutable does not collide with kernel texture headlessgl',
  () => {
