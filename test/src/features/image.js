(function() {
  function imageTest(mode) {
    var colorFn;
    switch (mode) {
      case 'cpu':
        // TODO
      case 'webgl':
        colorFn = `void color(sampler2D image) {
    ...
    document.body.insertBefore(imageKernel.getCanvas(), document.body.children[0]);
    document.body.insertBefore(image, document.body.children[0]);
    image.onload = function() {
      imageKernel(image);
    };
  }

  QUnit.test('graphical imageTest (auto)', function() {
    imageTest(null);
  });

  QUnit.test('graphical imageTest (gpu)', function() {
    imageTest('gpu');
  });

  QUnit.test('graphical imageTest (webgl)', function() {
    imageTest('webgl');
  });

  QUnit.test('graphical imageTest (webgl2)', function() {
    imageTest('webgl2');
  });

  // TODO
  // QUnit.test('graphical imageTest (CPU)', function() {
  //   imageTest('cpu');
  // });
})();