(function() {
  ...
  (GPU.isWebGL2Supported ? QUnit.test : QUnit.skip)('Issue #267 immutable kernel output - (webgl)', () => {
  ...
  (GPU.isWebGL2Supported ? QUnit.test : QUnit.skip)('Issue #267 immutable kernel output - (webgl2)', () => {
  ...
  (GPU.isHeadlessGLSupported ? QUnit.test : QUnit.skip)('Issue #267 immutable kernel output - (headlessgl)', () => {
...
(() => {
  ...
  (GPU.isWebGLSupported ? QUnit.test : QUnit.skip)('Issue #267 immutable sub-kernel output - (webgl)', () => {
    const gpu = new GPU({mode: 'webgl'});
    const kernel = immutableSubKernels(gpu);
  ...
  (GPU.isWebGL2Supported ? QUnit.test : QUnit.skip)('Issue #267 immutable sub-kernel output - (webgl2)', () => {
    const gpu = new GPU({mode: 'webgl2'});
    const kernel = immutableSubKernels(gpu);
  ...
  (GPU.isHeadlessGLSupported ? QUnit.test : QUnit.skip)('Issue #267 immutable sub-kernel output - (headlessgl)', () => {
    const gpu = new GPU({mode: 'headlessgl'});
    const kernel = immutableSubKernels(gpu);
...
(() => {
  ...
  (GPU.isWebGLSupported ? QUnit.test : QUnit.skip)('Issue #267 immutable kernel & sub-kernel output - (webgl)', () => {
    const gpu = new GPU({ mode: 'webgl' });
    const kernel = immutableKernelsMixed(gpu);
  ...
  (GPU.isWebGL2Supported ? QUnit.test : QUnit.skip)('Issue #267 immutable kernel & sub-kernel output - (webgl2)', () => {
    const gpu = new GPU({ mode: 'webgl2' });
    const kernel = immutableKernelsMixed(gpu);
  ...
  (GPU.isHeadlessGLSupported ? QUnit.test : QUnit.skip)('Issue #267 immutable kernel & sub-kernel output - (headlessgl)', () => {
    const gpu = new GPU({ mode: 'headlessgl' });
    const kernel = immutableKernelsMixed(gpu);
