(function() {
	...
	(GPU.isWebGLSupported ? QUnit.test : QUnit.skip)('Issue #346 uint8 input array - webgl', () => {
		buildUintArrayInputKernel('webgl', uint8data);
	});

	(GPU.isWebGL2Supported ? QUnit.test : QUnit.skip)('Issue #346 uint8 input array - webgl2', () => {
		buildUintArrayInputKernel('webgl2', uint8data);
	});

	(GPU.isHeadlessGLSupported ? QUnit.test : QUnit.skip)('Issue #346 uint8 input array - headlessgl', () => {
		buildUintArrayInputKernel('headlessgl', uint8data);
	});

	(GPU.isWebGLSupported ? QUnit.test : QUnit.skip)('Issue #346 uint16 input array - webgl', () => {
		buildUintArrayInputKernel('webgl', uint16data);
	});

	(GPU.isWebGL2Supported ? QUnit.test : QUnit.skip)('Issue #346 uint16 input array - webgl2', () => {
		buildUintArrayInputKernel('webgl2', uint16data);
	});

	(GPU.isHeadlessGLSupported ? QUnit.test : QUnit.skip)('Issue #346 uint16 input array - headlessgl', () => {
