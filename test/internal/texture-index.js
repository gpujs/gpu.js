...
(GPU.isWebGL2Supported ? test : skip)(
  'createKernel with number constants gpu',
  () => {
    createKernelWithNumberConstants('gpu');
  }
);
(GPU.isWebGL2Supported ? test : skip)(
  'createKernel with number constants webgl',
  () => {
    createKernelWithNumberConstants('webgl');
  }
);
(GPU.isWebGL2Supported ? test : skip)(
  'createKernel with number constants webgl2',
  () => {
    createKernelWithNumberConstants('webgl2');
  }
);
(GPU.isHeadlessGLSupported ? test : skip)(
  'createKernel with number constants headlessgl',
  () => {
...
function createKernelWithArrayConstants(mode) {
  ...
  const kernel = gpu.createKernel(
    function () {
      return (
        this.constants.v1[this.thread.x] + this.constants.v2[this.thread.x]
      );
    },
    { output: [1], constants: { v1: [1], v2: [1] } }
  );
...
(GPU.isGPUSupported ? test : skip)(
  'createKernel with array constants gpu',
  () => {
    createKernelWithArrayConstants('gpu');
  }
);
(GPU.isWebGLSupported ? test : skip)(
  'createKernel with array constants webgl',
  () => {
    createKernelWithArrayConstants('webgl');
  }
);
(GPU.isWebGL2Supported ? test : skip)(
  'createKernel with array constants webgl2',
  () => {
    createKernelWithArrayConstants('webgl2');
  }
);
(GPU.isHeadlessGLSupported ? test : skip)(
  'createKernel with array constants headlessgl',
  () => {
...
function creatKernelWithNumberConstantsAndArrayArguments(mode) {
  ...
  const kernel = gpu.createKernel(
    function (value1, value2) {
      return (
        value1[this.thread.x] +
        value2[this.thread.x] +
        this.constants.v1 +
        this.constants.v2
      );
    },
...
(GPU.isGPUSupported ? test : skip)(
  'createKernel with number constants & array arguments gpu',
  () => {
    creatKernelWithNumberConstantsAndArrayArguments('gpu');
  }
);
(GPU.isWebGLSupported ? test : skip)(
  'createKernel with number constants & array arguments webgl',
  () => {
    creatKernelWithNumberConstantsAndArrayArguments('webgl');
  }
);
(GPU.isWebGL2Supported ? test : skip)(
  'createKernel with number constants & array arguments webgl2',
  () => {
    creatKernelWithNumberConstantsAndArrayArguments('webgl2');
  }
);
(GPU.isHeadlessGLSupported ? test : skip)(
  'createKernel with number constants & array arguments headlessgl',
  () => {
...
function createKernelMapWithArrayConstantsAndTextureArguments(mode) {
  ...
  const kernel = gpu.createKernelMap(
    ...
    function (value1, value2) {
      return (
        calcValue1(value1[this.thread.x] + value2[this.thread.x]) +
        calcValue2(
          this.constants.v1[this.thread.x] + this.constants.v2[this.thread.x]
        )
      );
...
(GPU.isGPUSupported ? test : skip)(
  'createKernelMap with array constants & texture arguments gpu',
  () => {
    createKernelMapWithArrayConstantsAndTextureArguments('gpu');
  }
);
(GPU.isWebGLSupported ? test : skip)(
  'createKernelMap with array constants & texture arguments webgl',
  () => {
    createKernelMapWithArrayConstantsAndTextureArguments('webgl');
  }
);
(GPU.isWebGL2Supported ? test : skip)(
  'createKernelMap with array constants & texture arguments webgl2',
  () => {
    createKernelMapWithArrayConstantsAndTextureArguments('webgl2');
  }
);
(GPU.isHeadlessGLSupported ? test : skip)(
  'createKernelMap with array constants & texture arguments headlessgl',
  () => {
