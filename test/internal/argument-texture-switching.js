...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'Array without type defined (GPU only) auto',
  () => {
...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'Array without type defined (GPU only) gpu',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGLSupported ? test : skip)(
  'Array without type defined (GPU only) webgl',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGL2Supported ? test : skip)(
  'Array without type defined (GPU only) webgl2',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isHeadlessGLSupported ? test : skip)(
  'Array without type defined (GPU only) headlessgl',
  () => {
...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'Array with type defined (GPU only) auto',
  () => {
...
(GPU.isSinglePrecisionSupported ? test : skip)(
  'Array with type defined (GPU only) gpu',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGLSupported ? test : skip)(
  'Array with type defined (GPU only) webgl',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isWebGL2Supported ? test : skip)(
  'Array with type defined (GPU only) webgl2',
  () => {
...
(GPU.isSinglePrecisionSupported && GPU.isHeadlessGLSupported ? test : skip)(
  'Array with type defined (GPU only) headlessgl',
  () => {
