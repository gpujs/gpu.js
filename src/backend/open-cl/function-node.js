 ...
 *
 */
module.exports = class OpenCLFunctionNode extends FunctionNodeBase {
	generate() {
		if (this.debug) {
			console.log(this);
		}
		if (this.prototypeOnly) {
			return OpenCLFunctionNode.astFunctionPrototype(this.getJsAST(), [], this).join('').trim();
		} else {
	 ...
	 *
	 * @desc Returns the converted openCl shader function equivalent of the JS function
	 *
	 * @returns {String} openCl function string, result is cached under this.getFunctionPrototypeString
	 *
	 */
 ...
 * @ignore
 * @function
 * @name openClRegexOptimize
 *
 * @desc [INTERNAL] Takes the near final openCl function string, and do regex search and replacments.
 ...
 *
 */
function openClRegexOptimize(inStr) {
	return inStr
