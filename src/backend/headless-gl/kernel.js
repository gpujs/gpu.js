...
export class HeadlessGLKernel extends WebGLKernel {
  ...
  static setupFeatureChecks() {
    ...
    try {
      ...
      testExtensions = {
        STACKGL_resize_drawingbuffer: testContext.getExtension(
          'STACKGL_resize_drawingbuffer'
        ),
        STACKGL_destroy_context: testContext.getExtension(
        ...
        WEBGL_color_buffer_float: testContext.getExtension(
