///
/// File: kernelObj-format
///
/// kernelObj Format:
///
/// The kernelObj is an object that matches the following format.
/// This is generated via <exportKernelObj>
///
/// |---------------|---------------|---------------------------------------------------------------------------|
/// | Name          | Value Type    | Description                                                               |
/// |---------------|---------------|---------------------------------------------------------------------------|
/// | isKernelObj   | <Boolean>     | Boolean true flag, that is part of the kernel obj validation              |
